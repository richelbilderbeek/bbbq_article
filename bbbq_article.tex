...
Both TMH prediction tools struggle with selenocysteine,
the 21st amino acid incorporated in human proteins.
The human reference proteome used contains 30 selenoproteins.
TMHMM gives a clear error message, due to which we removed
...
nor do the authors respond to emails.
We assume PureseqTM ignores these residues.
In either case, we think that the effect of the 30 selenoproteins
on a proteome of 20600 proteins is only minor.
