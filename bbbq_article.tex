...
See \ref{fig:rel_presentation}
\ref{fig:rel_presentation_per_haplotype.png}
...
Figure \ref{fig:fig_rel_presentation_per_haplotype} shows the normalized
...
\begin{figure}[!htbp]
  ...
  \label{fig:fig_rel_presentation_per_haplotype}
\end{figure}
