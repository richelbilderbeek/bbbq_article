...
\frans{Is dit zo?} 
\richel{Volgens de (weggegevallen) referentie naar Lund et al., 2004, 'Definition of supertypes for {HLA} molecules using clustering of specificity matrices' wel}.
...
\frans{Analyzing the occurrence of single nucleotide polymorphisms that were predicted to be inside ...}
...
\richel{I suggest to move this section to the Supplementary Materials}
...
\geert{A narrative was missing a bit. Why was this done?}
...
\geert{Also add a conclusion at the end of the paragraph.}
...
Two biological sources of noise \geert{What do you mean by noise?}
...
\geert{This might be relevant, but you need to explain why it is relevant. Thus compare your findings with previous efforts to look at conservation of TMHs}
...
\geert{Should we include Maxim? He did the alignment of Mycobacterium tuberculosis. Let’s also ask Frans.}
