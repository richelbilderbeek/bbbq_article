...
[RJCB: that was the last paragraph I ruthlessly moved
from introduction to here, as was suggested by GVDB]
...
Two biological sources of noise [GVDB: What do you mean by noise?]
...
% Label: tab:ncbi_counts
\input{ncbi_peregrine_results/ncbi_counts.tex}
