...
This results in \richel{1126} gene IDs.
...
was limited to the first \richel{100} SNPs per gene,
resulting in \richel{112600} SNPs 
\richel{Note that \cite{musumeci2010single} demonstrates for a way to get
try SNPs, instead of SNDs, maybe I should use that}
.
...
amino acid substitution are kept, resulting in \richel{???} protein changes.
...
in \richel{???} proteins with at least one TMH. 
...
\begin{figure}[!htbp]
  \includegraphics[height=0.9\textheight]{../bbbq_1_smart/results_14-mer/fig_f_tmh_mhc1_2_grid.png}
  \caption{
...
\begin{figure}[!htbp]
  \includegraphics[height=0.9\textheight]{../bbbq_1_smart/results_14-mer/fig_f_tmh_mhc2_2_grid.png}
  \caption{
...
\input{../bbbq_1_smart/results_14-mer/table_f_tmh_2.latex}
...
\input{../bbbq_1_smart/results_14-mer/table_ic50_binders_mhc1_2.latex}

% tab:ic50_binders_mhc2
\input{../bbbq_1_smart/results_14-mer/table_ic50_binders_mhc2_2.latex}
...
\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../bbbq_1_smart/results_14-mer/fig_f_tmh_mhc1_2_normalized.png}
  \caption{
...
\input{../bbbq_1_smart/results_14-mer/table_tmh_binders_mhc1_2.latex}
...
\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../bbbq_1_smart/results_14-mer/fig_f_tmh_mhc2_2_normalized.png}
  \caption{
...
\input{../bbbq_1_smart/results_14-mer/table_tmh_binders_mhc2_2.latex}
...
\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../ncbi_peregrine/scripts/fig_f_snps_found_and_expected_per_n_tmhs.png}
  \caption{fig_f_snps_found_and_expected_per_n_tmhs}
  \label{fig:f_snps_found_and_expected_per_n_tmhs}
\end{figure}
)

\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../ncbi_peregrine/scripts/fig_f_snps_found_and_expected.png}
  \caption{fig_f_snps_found_and_expected}
  \label{fig:f_snps_found_and_expected}
\end{figure}

\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../ncbi_peregrine/scripts/fig_n_proteins_per_gene_name.png}
  \caption{fig_n_proteins_per_gene_name}
  \label{fig:n_proteins_per_gene_name}
\end{figure}

\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../ncbi_peregrine/scripts/fig_n_snps_found_and_expected_per_n_tmhs.png}
  \caption{fig_n_snps_found_and_expected_per_n_tmhs}
  \label{fig:n_snps_found_and_expected_per_n_tmhs}
\end{figure}

\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../ncbi_peregrine/scripts/fig_n_tmhs_per_protein.png}
  \caption{fig_n_tmhs_per_protein}
  \label{fig:n_tmhs_per_protein}
\end{figure}

\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../ncbi_peregrine/scripts/fig_snp_rel_pos.png}
  \caption{fig_snp_rel_pos}
  \label{fig:snp_rel_pos}
\end{figure}

\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../ncbi_peregrine/scripts/fig_snps_per_gene_name_ncbi.png}
  \caption{fig_snps_per_gene_name_ncbi}
  \label{fig:snps_per_gene_name_ncbi}
\end{figure}

\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../ncbi_peregrine/scripts/fig_snps_per_gene_name.png}
  \caption{fig_snps_per_gene_name}
  \label{fig:snps_per_gene_name}
\end{figure}


\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../ncbi_peregrine/scripts/fig_snps_per_gene_name_processed.png}
  \caption{fig_snps_per_gene_name_processed}
