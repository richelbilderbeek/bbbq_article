...
% GvdB: Not really relevant. You don’t really need to explain the role of DCs. What is far more important is the concept of what an MHC is: a protein complex that contains a fold, called the peptide-binding groove, which presents peptides. Also immediately explain that MHC-I presents peptides of about 9-amino acids in length to cytolytic T cells, whereas MHC-II presents longer peptides to helper T cells.
...
For example, 
15-39% 
\richel{Why wide range? Issue 180}
...
with TMHs, we used reference proteomes of 
...
used the representative human reference proteome 
...
with TMHs for our human, viral and bacterial proteome \richel{GvdB: you didn't explain yet which virus and bacteria}.
...
membrane-associated proteins \richel{Dit is nog niet goed uitgelegd}, and calculated the 95\%
confidence interval.
...
\begin{figure}[!htbp]
  ...
  \caption{
    ...
    if TMHs and soluble protein regions are equally conserved.
    \richel{GvdB: As discussed, I would simply plot 1 and multiple (>1) TMHs.}
  }
...
\richel{GvdB: Rewrite after pooling >1 TMHs}
...
\richel{
  ...
  proteins (like selenomethionines) 
  or you’d expect changes in the other direction (wrong prediction of TMHs for bacteria). 

  So offer interpretations. 
  The 2nd part of the introduction would fit here well. I can also help with this.
}
...
\richel{GvdB: Sounds a but irrelevant to me. Do you really want to mention this in the discussion?}
...
\richel{GvdB: Also irrelevant. Only 1 protein}
...
\richel{GvdB: Should we include Maxim? He did the alignment of Myc tub. Let’s also ask Frans.}
