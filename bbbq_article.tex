...
one finds 91.1 SNPs in TMHs, as shown by
...
important to fight diseases. By this paper, we suggest that epitopes
derived from TMHs are needlessly overlooked and may inspire to investigate
new potential targets for combating pathogens. We say 'needlessly',
as TMH-derived epitopes are predicted to be 
presented more often than expected by chance, 
combined with are finding that TMHs are evolutionary conserved.
...
is more pronounced than for MHC-I,
...
for the human proteome only and compared the averages between MHC-I and MHC-II.
See figure \ref{fig:fig_rel_presentation}.
...
\begin{figure}[!htbp]
  ...
  \label{fig:fig_rel_presentation}
\end{figure}
