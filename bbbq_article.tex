...
population \frans{Add references here}.
...
which are 'gene',\frans{snap ik niet which are gene?} to find the gene names of membrane proteins, 
...
\frans{ dit is relevant waarom: ? To retrieve the data from these databases the
...
epitopes derived from TMHs can and are presented on both MHC-I and MHC-II.
...
We next wondered if this over-representation would also generalize to MHC-II. \frans{ you say MHC-II but this is very general I think you have to explain the choice for these haplotypes.}
...
as MHC-I, yet this over-presentation is more pronounced. \frans{we should explain this does it like shown for mhc-I also linearly correlates with the hydrophopbicity of the MHC-II binding celft?}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Conclusion}\frans{why comes this section before discussion?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
