...
% GvdB:
% The text below here is more discussion 
% as it is already interpretation of the findings. 
% I would add one short paragraph, 
...
% GvdB: Move [the rest] to Discussion. I would keep the introduction short 
% and focus only on introducing the question; no interpretation yet.
%
