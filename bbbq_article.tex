...
To detect the evolutionary conservation of TMHs,
we create an alignment using msa, that uses msaClustalW in the back,
create a consensus sequence, determine the topology of the consensus
using the FLU transition matrix,
measure the topology of it, then estimate the conservation values.
