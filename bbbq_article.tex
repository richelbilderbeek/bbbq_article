...
\begin{figure}[!htbp]
  \includegraphics[height=0.9\textheight]{../bbbq_1_smart/fig_f_tmh_mhc1_2_grid.png}
  \caption{
...
\begin{figure}[!htbp]
  \includegraphics[height=0.9\textheight]{../bbbq_1_smart/fig_f_tmh_mhc2_2_grid.png}
  \caption{
...
\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{bbbq_2/8000_42/scores.png}
  \caption{
...
\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{bbbq_2/8000_42/scores_merged_violin.png}
  \caption{
...
\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{bbbq_2/8000_42/scores_violin.png}
  \caption{
    Evolutionary conservation scores of TMH versus non-TMH
    residues in the SARS-CoV-2 proteome,
    for proteins that have at least one TMH,
...
\input{../bbbq_1_smart/table_f_tmh_2.latex}
...
we collected all 9-mers (for MHC-I) and 15-mers (for MHC-II),
...
we predicted the IC50 using \verb;epitope-prediction; (for MHC-I)
...
\input{../bbbq_1_smart/table_ic50_binders_mhc1_2.latex}

% tab:ic50_binders_mhc2
\input{../bbbq_1_smart/table_ic50_binders_mhc2_2.latex}
...
\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../bbbq_1_smart/fig_f_tmh_mhc1_2_normalized.png}
  \caption{
...
\input{../bbbq_1_smart/table_tmh_binders_mhc1_2.latex}
...
\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{../bbbq_1_smart/fig_f_tmh_mhc2_2_normalized.png}
  \caption{
...
\input{../bbbq_1_smart/table_tmh_binders_mhc2_2.latex}
...
\begin{figure}[!htbp]
  \includegraphics[width=0.7\textwidth,scale=0.7]{bbbq_2/8000_42/scores_all.png}
  \caption{
    Conservation scores for the aligned SARS-CoV-2 proteomes,
    for all proteins,
    from a subset of 8000 randomly selected SARS-CoV-2 sequences.
...
\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{bbbq_2/8000_42/scores_violin_all.png}
  \caption{
    Evolutionary conservation scores of TMH versus non-TMH
    residues in the SARS-CoV-2 proteome,
    for all proteins,
...
\begin{figure}[!htbp]
  ...
  \caption{
    Conservation scores for the aligned SARS-CoV-2 proteomes,
    for proteins that have at least one TMH,
    using all unique sequences \richel{which I doubt is valid}.
    The (non-logarithmic) scale of the conservation score has been removed
    for readability.
    Conservation scores do not start at residue 1 when
    an aligned protein sequence outflanks the consensus sequence 
