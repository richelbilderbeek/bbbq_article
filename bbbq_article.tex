...
Instead of the default BLOSUM62 amino acid transition matrix (\cite{henikoff1992amino}),
...
\begin{figure}[!htbp]
  ...
  \caption{
    Conservation scores across the SARS-CoV-2 proteome
...
\begin{figure}[!htbp]
  \includegraphics[width=\textwidth]{bbbq_2/scores_all.png}
  \caption{
    Conservation scores across the SARS-CoV-2 proteome
    for all proteins
  }
