...
conserved by determining if SNPs are found in TMH more/less/equal
...
To detect the evolutionary conservation of TMHs, 
we use the follow workflow (also shown
...
'gene' to find the gene names of membane proteins, 
'dbSNP' for SNPs associated with those genes
and 'protein' to obtain the sequence of proteins that SNPs act upon.
The 'dbSNP' contains 2 billion (human-only) SNPs, although
it is estimated that approx 10 percent is a false positive 
\richel{see references on dbSNP Wikipedia page}.
