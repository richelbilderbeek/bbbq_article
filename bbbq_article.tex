...
\begin{itemize}
	\item Genome size: $\approx 3 \cdot 10^4$ bases
	\item Evolution rate: $\approx 10^{-3}$ per nucleotide per year (from \cite{bar2020sars})
	\item Evolution rate per genome: $\approx 26$ per year (GISAID)
	\item Evolution rate per nucleotide: $0.00088$ per nucleotide per year as $\frac{26}{\cdot 10^4}$ per nucleotide year
	\item Mutation rate: $\approx 10^{-6}$ per nucleotide per cycle
	...
	\item TMHs per proteome: 21 (from TMHMM)
