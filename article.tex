...
From \cite{anisimova2009investigating}, I quote: 
although most proteins evolve under purifying selection most of the time, 
positive selection may affect some lineages, and during episodes of adaptive 
evolution, only a small fraction of sites in the protein have the capacity 
to increase the 'fitness' of the protein via AA 
replacements (e.g., Gillespie 1991; Li 1997; Messier and Stewart 1997; 
Pupko and Galtier 2002). 
Thus, approaches assuming constant selective pressure over time and 
over sites lack power in detecting genes affected by positive 
selection (Yang and Bielawski 2000).



Commonly, DNA is used in phylogenetics.
Some argue that the proteome is superior \cite{diz2012proteomics}:
...
and ORF8 (unknown function) \cite{velazquez2020positive}. 
Of these two proteins, ORF3 has 3 TMHs,
yet selection was only detectable in non-TMHs.
