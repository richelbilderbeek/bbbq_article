...
\richel{Check against stupidity}
All nucleated cells in humans present randomly sampled polypeptide
...
\paragraph{Evolutionary signal of unknown strength}

\richel{Check against stupidity}
We do not know how viruses are selected \richel{so I should read the
literature on that}. We predict that there is a strong 
...
TMHs. Because the strength of the evolutionary signal,
are strong data set needs to be used.
...
in the transmembrane part of its proteome.
...
We compare these distributions using a two-sample 
...
\begin{figure}[!htbp]
  ...
  \caption{
    ...
    \richel{
      The Illuminati watermark indicates the data underlying this
      figure has been simulated
    }
  }
  \label{fig:1}
\end{figure}
