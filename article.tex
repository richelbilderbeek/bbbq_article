...
\richel{More detail here}.

For gene prediction, we used \richel{X} as is recommended
in a recent benchmark study for eukaryotes (\cite{scalzitti2020benchmark}).

Although the closed source Vgas (\cite{zhang2019vgas}) appears promising,
we opted for reproducible research and used Prodigal (\cite{hyatt2012gene})
instead, which was just a bit better than prokka (\cite{seemann2014prokka}).
