...
To do so, we calculate the probability of observing the complete
dataset, for which we need to calculate the probability 
...
\begin{figure}
  \centering
  \input{markov_chain_4_states.latex}
  \caption{
...
where, for example, the expected number of transitions is the sum of individual
probabilities. We calculate the probability of the observing our
