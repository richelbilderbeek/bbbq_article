...
parts of membrane proteins are TMH (as well as which side is inside
and outside). 
...
A later method such as \cite{kall2004combined} \richel{I should check}.
Other later methods, such as ConPred II (\cite{arai2004conpred})
and MetaTM (\cite{klammer2009metatm}) show promises, but
appear to be unavailable \richel{Uh, both servers are down?!?!}.
